...
// The action hook `add_action( 'widgets_init', 'solanawp_register_custom_widgets' );`
// will be called from the main SolanaWP/functions.php file, typically after the main widgets_init.
